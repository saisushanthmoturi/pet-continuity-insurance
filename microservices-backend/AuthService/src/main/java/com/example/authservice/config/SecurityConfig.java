...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        .pathMatchers("/api/auth/register", "/api/auth/login", "/api/auth/logout", "/api/auth/validate", "/actuator/**").permitAll()
    ...
    public WebFilter headerAuthenticationFilter() {
        return (exchange, chain) -> {
            ...
            String principal = (email != null && !email.isBlank()) ? email : (userId != null ? userId : "anonymous");
