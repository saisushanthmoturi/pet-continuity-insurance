package com.example.careverificationservice.aspect;
...
public class PerformanceLoggingAspect {
    ...
    @Pointcut("execution(* com.example.careverificationservice..*(..)) && !within(com.example.careverificationservice.aspect..*)")
    public void carePackagePointcut() {
    }

    @Around("carePackagePointcut()")
