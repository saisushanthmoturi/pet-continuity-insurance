package com.example.paymentfundservice.aspect;
...
public class PerformanceLoggingAspect {
    ...
    @Pointcut("execution(* com.example.paymentfundservice..*(..)) && !within(com.example.paymentfundservice.aspect..*)")
    public void paymentFundPackagePointcut() {
    }

    @Around("paymentFundPackagePointcut()")
