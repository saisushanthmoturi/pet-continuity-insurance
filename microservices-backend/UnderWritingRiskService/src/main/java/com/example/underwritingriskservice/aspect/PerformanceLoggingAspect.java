package com.example.underwritingriskservice.aspect;
...
public class PerformanceLoggingAspect {
    ...
    @Pointcut("execution(* com.example.underwritingriskservice..*(..)) && !within(com.example.underwritingriskservice.aspect..*)")
    public void underwritingPackagePointcut() {
    }

    @Around("underwritingPackagePointcut()")
